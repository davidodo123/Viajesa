...
<form action="{{ route('comentario.store') }}" method="post">
    ...
    <div class="upper-space mb-3" style="padding-top: 16px;">
        ...
        <textarea cols="60" rows="4" class="form-control" minlength="1" required id="text" name="content" placeholder="Que quieres comentar en {{ $vacacion->titulo }}...">{{ old('content') }}</textarea>
    </div>
